  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-8 text-center">
      ...
      <div className="text-xl lg:text-2xl font-light font-serif my-8 text-gray-700 dark:text-gray-200">
        Laravel&nbsp;Developer
        @&nbsp;<a href="https://nueprice.com/" target="_blank" className='underline hover:no-underline transition-opacity hover:opacity-75'>nueprice&nbsp;GmbH</a>
      </div>
      <div className="text-gray-700 dark:text-gray-200 grid grid-flow-col items-center gap-4">
        {socialLinks.map((item, index) => (
          <a key={index} href={item.url} title={item.title} target="_blank" className="p-2 transition-opacity hover:opacity-75">
